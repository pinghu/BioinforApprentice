...
setwd("~/Desktop/learn/BioinforApprentice/Problem1")
t1 <- Sys.time()#把程序运行之前的时间赋值给t1
download.file(url='https://ftp.ncbi.nlm.nih.gov/pub/CCDS/current_human/CCDS.current.txt',
              destfile='CCDS.current.txt', method='curl')
